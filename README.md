...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r00vp9o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r00vp9o.containers.anotherwebservice.com/
...
```
git clone git@github.com:InitialXKO/container-r00vp9o.git
cd container-r00vp9o
```
...
```
docker attach container-r00vp9o
```
